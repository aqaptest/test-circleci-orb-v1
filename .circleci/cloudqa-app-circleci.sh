...
function show_help {
    echo -e "Usage: Declare required environment variables in .travis.yml and then run bash \\n$0 . For more information check documentation at https://doc.cloudqa.io/TravisCI.html"
}
...
then
    ...
    echo -e "For usage, refer https://doc.cloudqa.io/TravisCI.html"
